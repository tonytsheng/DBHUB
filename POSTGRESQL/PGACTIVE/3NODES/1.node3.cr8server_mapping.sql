...
SELECT pgactive.pgactive_join_group(node_name := 'endpoint3-app'
  , node_dsn := 'host=pg1003.cyt4dgtj55oy.us-east-2.rds.amazonaws.com dbname=app port=5432 user=postgres password=Pass'
  , join_using_dsn := 'host=pg1001.cyt4dgtj55oy.us-east-2.rds.amazonaws.com dbname=app port=5432 user=postgres password=Pass');
