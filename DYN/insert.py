...
if __name__ == '__main__':
    flight_resp = put_flight("2020-12-08", "LH8455", "FRA", "", "HKG", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "GX8843", "AEB", "", "NNG", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "LH9753", "SIN", "", "AKL", 16, "active" ) 
    flight_resp = put_flight("2020-12-08", "O37169", "HGH", "", "TAO", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "NH203", "FRA", "", "HND", "", "scheduled" ) 
    ...
    flight_resp = put_flight("2020-12-08", "LX9003", "SIN", "", "AKL", 16, "active" ) 
    flight_resp = put_flight("2020-12-08", "NZ3282", "SIN", "", "AKL", 16, "active" ) 
    flight_resp = put_flight("2020-12-08", "SQ282", "SIN", "", "AKL", 16, "active" ) 
    ...
    flight_resp = put_flight("2020-12-08", "AY5095", "MEL", "", "HKG", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "BA4567", "MEL", "", "HKG", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "LH7013", "MEL", "", "HKG", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "LX9513", "MEL", "", "HKG", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "QR5830", "MEL", "", "HKG", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "OM5613", "MEL", "", "HKG", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "CX105", "MEL", "", "HKG", "", "scheduled" ) 
    ...
    flight_resp = put_flight("2020-12-08", "EY1004", "AKL", "", "PVG", 10, "scheduled" ) 
    ...
    flight_resp = put_flight("2020-12-08", "CZ441", "LAX", "", "PVG", 10, "scheduled" ) 
    ...
    flight_resp = put_flight("2020-12-08", "CZ473", "ANC", "", "CAN", 10, "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "JT794", "DJJ", "", "CGK", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "GJ8137", "WUH", "", "HRB", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "AF3118", "AMS", "", "ICN", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "KL832", "AMS", "", "ICN", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "AT9735", "DOH", "", "ICN", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "OZ6889", "DOH", "", "ICN", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "S74042", "DOH", "", "ICN", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "QR859", "DOH", "", "ICN", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "KL2345", "CDG", "", "ICN", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "AF267", "CDG", "", "ICN", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "KL856", "AMS", "", "ICN", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "OZ987", "PVG", "", "ICN", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "QF7524", "CHC", "", "AKL", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "QF7523", "CHC", "", "AKL", "", "scheduled" ) 
    ...
    flight_resp = put_flight("2020-12-08", "CF9101", "NKG", "", "TSN", "", "scheduled" ) 
    flight_resp = put_flight("2020-12-08", "YG9025", "CAN", "", "TSN", "", "scheduled" ) 
