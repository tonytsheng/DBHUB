...
if __name__ == '__main__':
    ...
    flight_resp = put_flight("2021-09-23", "IK77", "AER", "KHV", "active"  ) 
    flight_resp = put_flight("2021-09-23", "BA7905", "KUL", "BKI", "scheduled"  ) 
    flight_resp = put_flight("2021-09-23", "N477", "AER", "KHV", "active"  ) 
    flight_resp = put_flight("2021-09-23", "QR5442", "KUL", "BKI", "scheduled"  ) 
    flight_resp = put_flight("2021-09-23", "U6174", "SVX", "KHV", "active"  ) 
