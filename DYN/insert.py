...
if __name__ == '__main__':
    ...
    flight_resp = put_flight("2021-10-05", "NZ5704", "CHC", "IVC", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "SQ4528", "CHC", "IVC", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "QF8616", "CHC", "IVC", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "EK9824", "MEL", "SIN", "active"  ) 
    flight_resp = put_flight("2021-10-05", "CK217", "AMS", "PVG", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "3V816", "LGG", "HGH", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "YG9020", "SJW", "HGH", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "O36908", "SJW", "HGH", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "O36866", "PEK", "HGH", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "O37269", "SZX", "YNT", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "I99876", "SZX", "HFE", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "O37109", "PKX", "HFE", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "O36991", "PKX", "HFE", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "YG9078", "WUX", "KIX", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "CF216", "YIW", "KIX", "cancelled"  ) 
    flight_resp = put_flight("2021-10-05", "Y87952", "NGB", "KIX", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "FX90", "MEM", "KIX", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "CF226", "YIW", "KIX", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "QF7418", "MKY", "ROK", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "HT3810", "CGO", "KHN", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "O36960", "HGH", "KHN", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "O36999", "PKX", "CTU", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "UA200", "HNL", "GUM", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "HU8031", "PVG", "PEK", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "GI4107", "CGO", "CAN", "scheduled"  ) 
    ...
    flight_resp = put_flight("2021-10-05", "CF9021", "PVG", "PEK", "scheduled"  ) 
    ...
    flight_resp = put_flight("2021-10-05", "KL856", "AMS", "ICN", "active"  ) 
    flight_resp = put_flight("2021-10-05", "AF267", "CDG", "ICN", "active"  ) 
    flight_resp = put_flight("2021-10-05", "KL2345", "CDG", "ICN", "active"  ) 
    flight_resp = put_flight("2021-10-05", "KL832", "AMS", "ICN", "active"  ) 
    flight_resp = put_flight("2021-10-05", "AF5474", "AMS", "ICN", "active"  ) 
    flight_resp = put_flight("2021-10-05", "RU139", "HKG", "ICN", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "UA858", "SFO", "ICN", "active"  ) 
    ...
    flight_resp = put_flight("2021-10-05", "GI4231", "ICN", "CGO", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "ET3605", "LGG", "CGO", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "O36924", "HGH", "CGO", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "JT898", "UPG", "CGK", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "JT784", "UPG", "CGK", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "JT690", "SUB", "CGK", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "IW1332", "UPG", "CGK", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "IW1310", "UPG", "CGK", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "IW1206", "UPG", "CGK", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "ID6232", "UPG", "CGK", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "ID6182", "UPG", "CGK", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "ZL4351", "ADL", "PLO", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "QF7412", "BNE", "SYD", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "YG9118", "KMG", "HGH", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "GJ8712", "HRB", "HGH", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "YG9133", "KIX", "HGH", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "YG9001", "TSN", "HGH", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "YG9105", "NRT", "HGH", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "O37098", "WUH", "HGH", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "GI4027", "TSN", "WUX", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "G56297", "TSN", "XMN", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "G821", "HKT", "BOM", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "CF9065", "NKG", "XMN", "scheduled"  ) 
    flight_resp = put_flight("2021-10-05", "TH318", "BKI", "SZB", "scheduled"  ) 
