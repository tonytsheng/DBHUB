...
DROP FUNCTION IF EXISTS customers$tr_fn_ind_on_null();



DROP FUNCTION IF EXISTS inventory$tr_fn_ind_on_null();



DROP FUNCTION IF EXISTS orders$tr_fn_ind_on_null();



DROP FUNCTION IF EXISTS products$tr_fn_ind_on_null();



DROP FUNCTION IF EXISTS shipments$tr_fn_ind_on_null();



DROP FUNCTION IF EXISTS stores$tr_fn_ind_on_null();
...
ALTER TABLE customers DROP CONSTRAINT customers_email_u;
...
ALTER TABLE inventory DROP CONSTRAINT inventory_store_product_u;
...
ALTER TABLE order_items DROP CONSTRAINT order_items_product_u;
...
ALTER TABLE stores DROP CONSTRAINT store_at_least_one_address_c;



ALTER TABLE stores DROP CONSTRAINT store_name_u;



ALTER TABLE stores DROP CONSTRAINT stores_pk;



-- ------------ Write DROP-INDEX-stage scripts -----------

DROP INDEX IF EXISTS customers_name_i;



DROP INDEX IF EXISTS inventory_product_id_i;



DROP INDEX IF EXISTS order_items_shipment_id_i;



DROP INDEX IF EXISTS orders_customer_id_i;



DROP INDEX IF EXISTS orders_store_id_i;



DROP INDEX IF EXISTS shipments_customer_id_i;



DROP INDEX IF EXISTS shipments_store_id_i;



-- ------------ Write DROP-VIEW-stage scripts -----------

DROP VIEW IF EXISTS a_product_orders;



DROP VIEW IF EXISTS customer_order_products;
...
DROP VIEW IF EXISTS product_reviews;



DROP VIEW IF EXISTS store_orders;
...
DROP SEQUENCE IF EXISTS seq_customers$def_on_null;



DROP SEQUENCE IF EXISTS seq_inventory$def_on_null;



DROP SEQUENCE IF EXISTS seq_orders$def_on_null;



DROP SEQUENCE IF EXISTS seq_products$def_on_null;



DROP SEQUENCE IF EXISTS seq_shipments$def_on_null;



DROP SEQUENCE IF EXISTS seq_stores$def_on_null;
...
CREATE SEQUENCE IF NOT EXISTS seq_customers$def_on_null
INCREMENT BY 1
START WITH 393
...
CREATE SEQUENCE IF NOT EXISTS seq_inventory$def_on_null
INCREMENT BY 1
START WITH 567
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS seq_orders$def_on_null
INCREMENT BY 1
START WITH 1951
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS seq_products$def_on_null
INCREMENT BY 1
START WITH 47
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS seq_shipments$def_on_null
INCREMENT BY 1
START WITH 2027
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS seq_stores$def_on_null
INCREMENT BY 1
START WITH 24
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE OR REPLACE VIEW a_product_orders (product_name, order_status, total_sales, order_count) AS
SELECT
...
CREATE OR REPLACE VIEW customer_order_products (order_id) AS
/*
...
CREATE OR REPLACE VIEW product_reviews (text, error_msg) AS
...
CREATE OR REPLACE VIEW store_orders (text, error_msg) AS
...
CREATE OR REPLACE FUNCTION customers$tr_fn_ind_on_null()
RETURNS trigger
AS
$BODY$
BEGIN
...
CREATE OR REPLACE FUNCTION inventory$tr_fn_ind_on_null()
RETURNS trigger
AS
$BODY$
BEGIN
...
CREATE OR REPLACE FUNCTION orders$tr_fn_ind_on_null()
RETURNS trigger
AS
$BODY$
BEGIN
...
CREATE OR REPLACE FUNCTION products$tr_fn_ind_on_null()
RETURNS trigger
AS
$BODY$
BEGIN
...
CREATE OR REPLACE FUNCTION shipments$tr_fn_ind_on_null()
RETURNS trigger
AS
$BODY$
BEGIN
...
CREATE OR REPLACE FUNCTION stores$tr_fn_ind_on_null()
RETURNS trigger
AS
$BODY$
BEGIN
...
EXECUTE PROCEDURE customers$tr_fn_ind_on_null();
...
EXECUTE PROCEDURE inventory$tr_fn_ind_on_null();
...
EXECUTE PROCEDURE orders$tr_fn_ind_on_null();
...
EXECUTE PROCEDURE products$tr_fn_ind_on_null();
...
EXECUTE PROCEDURE shipments$tr_fn_ind_on_null();
...
EXECUTE PROCEDURE stores$tr_fn_ind_on_null();
